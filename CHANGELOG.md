...
- **Phase 4 release tag rehearsal** ([`docs/reports/2026-05-11_phase-4-release-rehearsal.md`](./docs/reports/2026-05-11_phase-4-release-rehearsal.md)): audits arc42 §1 §6 success criteria against the merged state; identifies one strict blocker (tutorial 06 — design-walkthrough mode recommended) and one soft blocker (01-04 scaffolds — recommend drop); walks the Git Flow release ceremony as a checklist with line-references. The actual `0.1.0` cut is not performed in this PR.
