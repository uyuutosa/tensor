...
**Shipped / in-flight as of 2026-05-11**: `tensor::core` (Phase 1 ✅), `tensor::tex` Phase 1 MVP ✅, `tutorials/00_intro.ipynb` ✅, `tensor::autograd` Phase 2 MVP ✅ (P2.M1 in [`../../impl-plans/2026-05-11_phase-2-autograd.md`](../../impl-plans/2026-05-11_phase-2-autograd.md)). Remaining: `tensor::gpu`, Jupyter Book site, `lyx-export/`.
