...
| 2026-05-14 | [`2026-05-14_documentation-pdca-100-cycles.md`](./2026-05-14_documentation-pdca-100-cycles.md)                          | 100-cycle docs PDCA run — vertical-depth fill (per-DD §6/§7/§8 + Diátaxis quadrant population + design-guide + ADR audit + glossary completeness). |
| 2026-05-14 | [`2026-05-14_phase-6-5-set-backend-retrospective.md`](./2026-05-14_phase-6-5-set-backend-retrospective.md)               | Phase 6.5 close — M1–M3 + M4 prep across 4 PRs (#119, #123, #124, #125); documents the R-P6.5.5 nanobind type-registry discovery + recovery to single-backend-per-process semantics. |
