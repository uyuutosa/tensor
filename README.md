...
| [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/uyuutosa/tensor/blob/main/python/notebooks/05_swappable-backends.ipynb) [`05`](./python/notebooks/05_swappable-backends.ipynb) | **Swappable backends** — `tensor.set_backend()` API + `pip install tensor-named-axis[eigen]/[webgpu]/[all]` extras + R-P6.5.5 process-scope semantics (Phase 6.5) |
